...
namespace MengeVis {
  namespace Runtime {
    namespace VCContext {
      ...
      /*!
       *  @brief    The context for the NearestEnemComponent.
       */
      class MENGEVIS_API TargetVelContext : public VelCompContext {
      public:
        /*!
      ...
      protected:
         ...
         */
        const Napoleon::NearestEnemComponent * _vc;
      };
    } // namespace VCContext
  } // namespace Runtime
} // namespace MengeVis
