...
#ifndef __ATTACK_VIS_ELEMENT_H_
#define __ATTACK_VIS_ELEMENT_H_
...
namespace Napoleon {
    /*!
     *  @brief    A simple class for drawing a attack event (line segment).
     *        The obstacle is drawn with lines in 3D space.
     */
    class MENGEVIS_API VisAttack : public MengeVis::SceneGraph::GLNode {
    public:
      /*!
       *  @brief    Constructor.
       *
       ...
       */
     VisAttack(const Menge::Math::Vector3& p0, const Menge::Math::Vector3& p1);
